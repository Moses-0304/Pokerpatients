...
public interface IPsLogic {
     ...
     * @throws IllegalStateException if a card is already picked but not added to a
     *                               pile.
     */
     ...
     * @throws IllegalStateException if there is no next card (null), the selected
     *                               pile
    ...
    /**
     * Return a copy of the internal list of piles, with copies of the piles in the
     * list.
     *
    ...
    /**
     * Calculate the total points in the internal piles, using
     * PokerHands.getPokerCombo.
     *
